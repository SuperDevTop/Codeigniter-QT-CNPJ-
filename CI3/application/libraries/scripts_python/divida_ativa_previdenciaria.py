...
try:
	...
	print('OK')
        ...
        driver.find_element_by_xpath("/html/body/div[2]/table/tbody/tr[1]/td/form/table/tbody/tr/td[4]/table").click()
        driver.find_element_by_id("debcadsForm:consultarDebcadsButton").click()
