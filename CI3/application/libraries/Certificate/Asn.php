...
require_once(APPPATH.'libraries/Certificate/Oids.php');
require_once(APPPATH.'libraries/Certificate/Base.php');
...
class Asn extends Base
{
	 ...
	 * getCPFCert
	 *
	 * Obtêm o numero de CPF da chave publica do Certificado (A1)
	 *
	 * @param  string $certpem conteúdo do certificado
	 * @return string CPF
	 */
	public static function getCPFCert($certPem)
	{
		...
		if(count($data) > 0)
		{
			$cpf = substr($data[0][1][1][0][1], 8, 11);
			return $cpf;
		}
		return '';
	}
