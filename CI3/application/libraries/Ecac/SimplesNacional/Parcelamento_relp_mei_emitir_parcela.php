...
class Parcelamento extends Ecac
{
    ...
    {
        $page = $this->exec('https://sinac.cav.receita.fazenda.gov.br/SimplesNacional/Aplicacoes/ATSPO/relpmei.app/Default.aspx', array(''), '', false, $this->cookie_complemento);
    ...
    private function obter_informacao_pedido($page)
    {
        ...
        foreach ($trs as $tr) {
            if ($i > 0) {
                ...
                $parcela_entrada = trim($tr->find('td')[2]->plaintext);
    ...
    private function obter_relacao_debitos_parcelas($page, $numero_parcelamento)
    {
        ...
        //     "Referer: https://sinac.cav.receita.fazenda.gov.br/simplesnacional/Aplicacoes/ATSPO/relpmei.app/ConsultaPedidoDetalhes.aspx",
        //     "Accept-Language: pt-BR,pt;q=0.9",
        //  );
        // $page = $this->exec("https://sinac.cav.receita.fazenda.gov.br/simplesnacional/Aplicacoes/ATSPO/relpmei.app/Recibo.aspx?nroCnpj={$cnpj}&nroParcelamento={$numero_parcelamento}&nroConsolidacao=1&pagina=ConsultaPedidoDetalhes", $headers, '', false, $this->cookie_complemento);
        $html = new Simple_html_dom();
        $html->load($page);
    ...
    private function post($post_fields)
    {
        ...
        $url = "https://sinac.cav.receita.fazenda.gov.br/SimplesNacional/Aplicacoes/ATSPO/relpmei.app/Default.aspx";
        ...
        $headers = array(
            ...
            "Sec-Fetch-User: ?1",
            "Sec-Fetch-Dest: iframe",
            "Referer: https://sinac.cav.receita.fazenda.gov.br/SimplesNacional/Aplicacoes/ATSPO/relpmei.app/Default.aspx",
            "Accept-Language: pt-BR,pt;q=0.9",
        );
    ...
    {
        $url = "https://sinac.cav.receita.fazenda.gov.br/SimplesNacional/Aplicacoes/ATSPO/relpmei.app/ConsultaPedido.aspx";
    ...
    {
        $url = "https://sinac.cav.receita.fazenda.gov.br/simplesnacional/Aplicacoes/ATSPO/relpmei.app/ConsultaPedidoDetalhes.aspx";
        $headers = array(
            "Connection: keep-alive",
            "Cache-Control: max-age=0",
            'sec-ch-ua: " Not A;Brand";v="99", "Chromium";v="96", "Google Chrome";v="96"',
    ...
    function obter_simples_nacional_emissao_parcela()
    {
        ...
        //     return;
        $page = $this->exec('https://sinac.cav.receita.fazenda.gov.br/SimplesNacional/Aplicacoes/ATSPO/relpmei.app/Default.aspx');
        $html = new Simple_html_dom();
        $html->load($page);
        ...
        $div_principal = $html->find('div[id=ctl00_contentPlaceH_gdvParcelas]', 0);
    ...
    function download_parcela_simplesnacional($data_parcela)
    {
        ...
        while ($tentativa) {
            ...
            // $url = "https://sinac.cav.receita.fazenda.gov.br/simplesnacional/Aplicacoes/ATSPO/relpmei.app/EmitirDAS.aspx";
            $url = "https://sinac.cav.receita.fazenda.gov.br/simplesnacional/Aplicacoes/ATSPO/relpmei.app/ReemitirDAS.aspx";
            $headers = array(
                "Connection: keep-alive",
                "Cache-Control: max-age=0",
                'sec-ch-ua: " Not A;Brand";v="99", "Chromium";v="96", "Google Chrome";v="96"',
            ...
            if ($div_principal) {
                ...
                array_shift($linhas); // remove a primeira linha, porque é o cabeçalho da table
                foreach ($linhas as $linha) {
                    echo trim($linha->find('td', 0)->plaintext)."<br>";
                ...
                if ($erro_laco == true || $achou_parcela == false) {
                    
                   $retorno = $this->download_parcela_simplesnacional2($data_parcela);
                }
    ...
    function download_parcela_simplesnacional2($data_parcela)
    {
        $data_atual = date('Ymdhis');
        $tentativa = 5;
        ...
        while ($tentativa) {
            ...
            $div_principal = $html->find('table[id=ctl00_contentPlaceH_gdvParcelas]', 0);
            // $div_principal = $html->find('table[id=ctl00_contentPlaceH_gdvParcela]', 0);
            $retorno = '';
            echo $div_principal;
