...
class Cron_bases_menores extends CI_Controller
{
    ...
    public function rodar_crescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas > 0 AND qtd_empresas <= 100 ORDER BY banco_de_dados asc");
    ...
    public function rodar_decrescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas > 0 AND qtd_empresas <= 100 ORDER BY banco_de_dados desc");
        $consulta = mysqli_query($con, $query);   
