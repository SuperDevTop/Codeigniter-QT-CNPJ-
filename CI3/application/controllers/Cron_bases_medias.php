...
class Cron_bases_medias extends CI_Controller
{
    ...
    public function rodar_crescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas >= '100' AND qtd_empresas <= '200' ORDER BY banco_de_dados asc");
    ...
    public function rodar_decrescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas >= '100' AND qtd_empresas <= '200' ORDER BY banco_de_dados desc");
        $consulta = mysqli_query($con, $query);   
