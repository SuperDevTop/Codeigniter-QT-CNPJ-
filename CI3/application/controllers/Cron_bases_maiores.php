...
class Cron_bases_maiores extends CI_Controller
{
    ...
    public function rodar_crescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas >= '200' AND qtd_empresas <= '500' ORDER BY banco_de_dados asc");
        $consulta = mysqli_query($con, $query);   

        while($dados = mysqli_fetch_assoc($consulta)){    

            $banco_de_dados = $dados['banco_de_dados']; 
            $this->buscar_01($banco_de_dados);
        }    
    }

    public function rodar_decrescente(){
        ...
        $query = ("SELECT * FROM `dtb_bases` WHERE qtd_empresas >= '200' AND qtd_empresas <= '500' ORDER BY banco_de_dados desc");
        $consulta = mysqli_query($con, $query);   
