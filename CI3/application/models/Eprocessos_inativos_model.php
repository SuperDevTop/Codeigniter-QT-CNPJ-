...
class Eprocessos_inativos_model extends CI_Model {
	...
	public function clear($banco){
		return $this->db->truncate($banco.'.dtb_ecac_eprocessos_inativos');
	}
    ...
    public function insert($cnpj, $processo, $banco){
		...
		$this->db->insert($banco.'.dtb_ecac_eprocessos_inativos', $this);
